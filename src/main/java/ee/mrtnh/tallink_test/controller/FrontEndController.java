...
public class FrontEndController {
    ...
    @GetMapping(value = "/viewConferences/{conferenceId}")
    public ResponseEntity<Conference> getConferenceById(@PathVariable String conferenceId) {
        log.info("Call for FrontEndController -> getConferenceById/{}", conferenceId);

        Conference conference = frontEndService.getConferenceById(conferenceId);
